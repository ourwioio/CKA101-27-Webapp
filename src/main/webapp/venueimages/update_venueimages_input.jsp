...
<title>場地資料修改 - update_venueimages_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>場地圖片資料修改 - update_venueimages_input.jsp</h3>
...
<FORM METHOD="post" ACTION="venueimages.do" name="form1" enctype="multipart/form-data">
<table>
    <tr>
	...
	<tr>
		...
		<td>${viVO.venueId}</td>
<!-- 		<td>場地編號:</td> -->
<%-- 		<td><input type="TEXT" name="venueId" value="${viVO.venueId}" size="45"/></td> --%>
	</tr>
	
	<tr>
		<td>場地圖片:</td>
		<td><input type="file" name="upfile1" accept=".jpg, .jpeg, .png"/></td> <td></td>
	</tr>
</table>
